 ...
 */
public class CeylonParserM2 extends CeylonParser implements PsiParser, CeylonTokenTypes, CeylonElementTypes {

    public static final CeylonParserM2 INSTANCE = new CeylonParserM2();
