...
PACKAGE_IDENTIFIER={LOWERCASE_IDENTIFIER_PREFIX}?{LOWERCASE_CHARACTER}+
...
CHARACTER_CODE="u"{HEX_DIGIT}{4}|"U"{HEX_DIGIT}{8}
HEX_DIGIT={DIGIT}|{UPPERCASE_CHARACTER}
...
<YYINITIAL> {DIGIT} { return CeylonTokenTypes.DIGIT; }
<YYINITIAL> {DIGITS} { return CeylonTokenTypes.DIGITS; }
...
<YYINITIAL> {FRACTIONAL_DIGITS} { return CeylonTokenTypes.FRACTIONAL_DIGITS; }

<YYINITIAL> {EXPONENT} { return CeylonTokenTypes.EXPONENT; }
<YYINITIAL> {MAGNITUDE} { return CeylonTokenTypes.MAGNITUDE; }
<YYINITIAL> {FRACTIONAL_MAGNITUDE} { return CeylonTokenTypes.FRACTIONAL_MAGNITUDE; }
...
<YYINITIAL> {PACKAGE_IDENTIFIER} { return CeylonTokenTypes.PACKAGE_IDENTIFIER; }
